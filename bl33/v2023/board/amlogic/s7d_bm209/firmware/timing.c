...
#endif
ddr_set_ps0_only_t __ddr_setting[] __attribute__ ((section(".ddr_param"))) = {0};
...
#define DQ_PXP_OFFSET   0
		...
		//s7d real pinmux also need fine tune ac delay
		.cfg_board_common_setting.ac_pinmux = {
			7,	1,	0,	3,	5,	4,	2,	0,	0,
			0,	6,	8,	9,	28,	29,
		...
		#else
		.cfg_ddr_training_delay_ps.ac_trace_delay[4] = 256 - 0, // cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[6] = 256 + 0, // cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[17] = 128 + 128, //cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[19] = 128 + 128, //cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[11] = 256,	//cke
		.cfg_ddr_training_delay_ps.ac_trace_delay[12] = 256,	//cke
		.cfg_ddr_training_delay_ps.ac_trace_delay[27] = 256,	//cke
		.cfg_ddr_training_delay_ps.ac_trace_delay[26] = 256,	//cke
		.cfg_ddr_training_delay_ps.ac_trace_delay[3] = 256,	//ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[4] = 256,	//ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[28] = 256,	//ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[29] = 256,	//ck
		#endif
...
#if PXP_USE_REAL_PINMUX
		//s7 real pinmux also need fine tune ac delay
		.cfg_board_common_setting.ac_pinmux = {
...
#if ENABLE_CP_DDR4_TIMMING
		.cfg_board_common_setting.ddr_dq_remap = {
			12,	10,	15,	13,	9,	8,	14,	33,	11,
			6,	4,	0,	2,	32,	1,	3,	5,	7,
...
//rtl debug
	...
	//S7D REAL PINMUX DELAY
		.cfg_ddr_training_delay_ps.ac_trace_delay[0] = 128 + AC_OFFSET,    //pxp cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[1] = 128 + AC_OFFSET,     //pxp cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[29] = 128 + AC_OFFSET,  //ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[28] = 128 + AC_OFFSET,  //ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[26] = 128 + AC_OFFSET,      //cke
		.cfg_ddr_training_delay_ps.ac_trace_delay[27] = 128 + AC_OFFSET,      //cke
