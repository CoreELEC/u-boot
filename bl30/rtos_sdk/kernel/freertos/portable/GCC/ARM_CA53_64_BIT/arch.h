...
#define MDCR_NSPB_EL1		(0x3)
#define MDCR_TDOSA_BIT		((1) << 10)
#define MDCR_TDA_BIT		((1) << 9)
#define MDCR_TPM_BIT		((1) << 6)
#define MDCR_EL3_RESET_VAL	(0x0)
...
#define MDCR_EL2_E2PB_EL1	(0x3)
#define MDCR_EL2_TDRA_BIT	((1) << 11)
#define MDCR_EL2_TDOSA_BIT	((1) << 10)
#define MDCR_EL2_TDA_BIT	((1) << 9)
#define MDCR_EL2_TDE_BIT	((1) << 8)
#define MDCR_EL2_HPME_BIT	((1) << 7)
#define MDCR_EL2_TPM_BIT	((1) << 6)
#define MDCR_EL2_TPMCR_BIT	((1) << 5)
#define MDCR_EL2_RESET_VAL	(0x0)
...
#define PMCR_EL0_RESET_VAL	(0x0)
#define PMCR_EL0_N_SHIFT	(11)
#define PMCR_EL0_N_MASK		(0x1f)
#define PMCR_EL0_N_BITS		(PMCR_EL0_N_MASK << PMCR_EL0_N_SHIFT)
#define PMCR_EL0_LC_BIT		((1) << 6)
#define PMCR_EL0_DP_BIT		((1) << 5)
#define PMCR_EL0_X_BIT		((1) << 4)
#define PMCR_EL0_D_BIT		((1) << 3)
