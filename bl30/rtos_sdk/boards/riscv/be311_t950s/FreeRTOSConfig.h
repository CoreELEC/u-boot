...
#define configCPU_CLOCK_HZ 1000000 //use soc ao domain timerA as tick
...
#define configSOC_TIMER_AS_TICK 1 //use soc ao domain timerA as tick
...
// FIXME: Need to redefine configSTICK_MEM_ADDR to a appropriate address.
