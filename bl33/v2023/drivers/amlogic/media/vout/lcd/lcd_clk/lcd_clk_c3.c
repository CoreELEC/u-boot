...
static void lcd_clk_disable_c3(struct aml_lcd_drv_s *pdrv)
{
	...
	//pll disable
	lcd_ana_setb(ANACTRL_GP0PLL_CTRL0, 0, 28, 1);
	//pll rst
	lcd_ana_setb(ANACTRL_GP0PLL_CTRL0, 1, 29, 1);
}
...
static struct lcd_clk_data_s lcd_clk_data_c3 = {
	...
	.pll_out_fmax = (6000 * 1000),  //khz
	.pll_out_fmin = (375 * 1000),   //khz
	.div_in_fmax = (1600 * 1000),   //khz
	.div_out_fmax = (1600 * 1000),  //khz
	.xd_out_fmax = (200 * 1000),    //khz
