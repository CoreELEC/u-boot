...
#include <dt-bindings/amlogic/gpio/meson-t5m-gpio.h>
...
static struct meson_pmx_group meson_t5m_periphs_groups[] = {
...
static struct meson_pmx_func meson_t5m_periphs_functions[] = {
...
static struct meson_bank meson_t5m_periphs_banks[] = {
	...
	BANK_DS("P",    GPIOP_0,    GPIOP_9,
		0x3b, 0,   0x3c, 0,   0x3a, 0,  0x39, 0,  0x38, 0,  0x3f, 0),
	BANK_DS("W",    GPIOW_0,    GPIOW_16,
...
static int meson_t5m_parse_dt_extra(struct meson_pinctrl *pc)
{
...
static struct meson_pinctrl_data meson_t5m_periphs_pinctrl_data = {
	...
	.parse_dt	= meson_t5m_parse_dt_extra,
};
