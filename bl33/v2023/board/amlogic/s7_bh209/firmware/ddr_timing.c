...
//rtl debug
...
#ifdef CONFIG_BOARD_TIMMING
		.cfg_ddr_training_delay_ps.dac_offset[0] = (1 << 7) | 0x6,
		.cfg_ddr_training_delay_ps.dac_offset[1] = (0 << 7) | 0x6,
		.cfg_ddr_training_delay_ps.reserve_para[0] = (1 << 7) | 0x9,     //write dqs
		.cfg_ddr_training_delay_ps.reserve_para[1] = (1 << 7) | 0x8,     //write dqs
		.cfg_ddr_training_delay_ps.reserve_para[2] = (1 << 7) | 0xe,     //write dqs
		.cfg_ddr_training_delay_ps.reserve_para[3] = (1 << 7) | 0x11,     //write dqs
		...
		.cfg_ddr_training_delay_ps.reserve_para[8 + 0] = (1 << 7) | 0x16,//read dqs
		.cfg_ddr_training_delay_ps.reserve_para[8 + 1] = (1 << 7) | 0x16,//read dqs
		.cfg_ddr_training_delay_ps.reserve_para[8 + 2] = (1 << 7) | 0x1b,//read dqs
		.cfg_ddr_training_delay_ps.reserve_para[8 + 3] = (1 << 7) | 0x1b,//read dqs
		...
		.cfg_ddr_training_delay_ps.ac_trace_delay[19] = 256 + AC_OFFSET,      //odt1

		.cfg_ddr_training_delay_ps.ac_trace_delay[7] = 87 + AC_OFFSET,
		//cs easy to do right offset
		.cfg_ddr_training_delay_ps.ac_trace_delay[10] = 128 + AC_OFFSET,      // cs
		.cfg_ddr_training_delay_ps.ac_trace_delay[28] = 128 + AC_OFFSET,    //ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[29] = 128 + AC_OFFSET,    //ck
		.cfg_ddr_training_delay_ps.ac_trace_delay[27] = 128 + AC_OFFSET,     //cke
		...
		.cfg_ddr_training_delay_ps.soc_bit_vref3[34] = 0x00000030,
		.cfg_ddr_training_delay_ps.soc_bit_vref3[35] = 0x00000030,
		.cfg_ddr_training_delay_ps.dram_vref[0] = 0x0000001c,
		.cfg_ddr_training_delay_ps.dram_vref[1] = 0x00000000,
		.cfg_ddr_training_delay_ps.dram_vref[2] = 0x00000000,
		.cfg_ddr_training_delay_ps.dram_vref[3] = 0x00000000,
		.cfg_ddr_training_delay_ps.dram_vref[4] = 0x00000000,
