...
static const struct GpioBank gpioBanks[BANK_NUM_MAX] = {
	...
	BANK("C", &eeDomain, 0x53, 0, 0x54, 0, 0x52, 0, 0x51, 0, 0x50, 0, 0x09,
	     0, 0x57, 0),
	BANK("D", &eeDomain, 0x33, 0, 0x34, 0, 0x32, 0, 0x31, 0, 0x30, 0, 0x02,
	     0, 0x37, 0),
	BANK("F", &eeDomain, 0x3b, 0, 0x3c, 0, 0x3a, 0, 0x39, 0, 0x38, 0, 0x08,
	     4, 0x3f, 0),
	...
	BANK("Z", &eeDomain, 0x03, 0, 0x04, 0, 0x02, 0, 0x01, 0, 0x00, 0, 0x06,
	     0, 0x07, 0),
	BANK("A", &eeDomain, 0x73, 0, 0x74, 0, 0x72, 0, 0x71, 0, 0x70, 0, 0x10,
	     0, 0x77, 0),
	BANK("TEST_N", &eeDomain, 0x83, 0, 0x84, 0, 0x82, 0, 0x81, 0, 0x80, 0,
	     0x0f, 0, 0x87, 0),
	BANK("CC", &eeDomain, 0x91, 2, 0x91, 4, 0x92, 0, 0x91, 0, 0x90, 0, 0x05,
	     24, 0x91, 6),
};
...
static const struct GpioIRQBank irqBanks[BANK_NUM_MAX] = {
	...
	GPIO_IRQ_BK("D",      25, eeIRQs, ARRAY_SIZE(eeIRQs)),
	GPIO_IRQ_BK("F",      32, eeIRQs, ARRAY_SIZE(eeIRQs)),
