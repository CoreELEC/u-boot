...
typedef struct boot_img_hdr_v3 boot_img_hdr_v3_t;
typedef struct boot_img_hdr_v3 *p_boot_img_hdr_v3_t;
...
typedef struct boot_img_v3 boot_img_v3_t;
typedef struct boot_img_v3 *p_boot_img_v3_t;
