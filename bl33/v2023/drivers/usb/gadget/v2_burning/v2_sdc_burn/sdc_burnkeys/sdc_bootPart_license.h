...
typedef struct _bootPartKeyInf_Item{
	...
	unsigned char   resv1[AML_BOOT_PART_KEY_ITEM_SZ - sizeof(unsigned int) * 6 - AML_BOOT_PART_KEY_ITEM_NAME_LEN];
...
int optimus_sdc_bootPart_lic_update_key_inf(const char *keyName, unsigned char *keyVal,
					    unsigned int keyLen);
