...
void vAdcInit(void)
{
	...
	/* Filter control */
	REG32(P_SARADC(SARADC_REG7)) = SARADC_REG7_INIT;
	REG32(P_SARADC(SARADC_REG8)) = SARADC_REG8_INIT;

	/* Delay configure */
	REG32(P_SARADC(SARADC_REG3)) = SARADC_REG3_INIT;
	REG32(P_SARADC(SARADC_REG4)) = SARADC_REG4_INIT;
	REG32(P_SARADC(SARADC_REG5)) = SARADC_REG5_INIT;

	/* Control */
	REG32(P_SARADC(SARADC_REG6)) = SARADC_REG6_INIT;

	/* Set aux and extern vref */
	REG32(P_SARADC(SARADC_REG9)) = SARADC_REG9_INIT;
	REG32(P_SARADC(SARADC_REG10)) = SARADC_REG10_INIT;
	REG32(P_SARADC(SARADC_REG11)) = SARADC_REG11_INIT;
