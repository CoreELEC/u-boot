...
// Project name: s1a
//
// Create time: Sat Apr  1 22:40:27 CST 2023 by chong.gu
//
// ./mmc_reg.vh
//
// DO NOT EDIT!!!!!
...
//
// -----------------------------------------------
// REG_BASE:  DMC_SEC_REG_BASE = 0xfe037000
// -----------------------------------------------
...
#define DDR_APB_SEC_CTRL                           ((0x00f0  << 2) + 0xfe037000)
...
#define DMC_SEC_STATUS                             ((0x00f2  << 2) + 0xfe037000)
 //bit 31~7. not used.
 //bit 6
 //bit 5
 //bit 4
...
#define DMC_VIO_ADDR0                              ((0x00f3  << 2) + 0xfe037000)
  //ddr0 write secure violation address.
#define DMC_VIO_ADDR1                              ((0x00f4  << 2) + 0xfe037000)
...
#define DMC_VIO_ADDR2                              ((0x00f5  << 2) + 0xfe037000)
  //ddr0 read secure violation address
#define DMC_VIO_ADDR3                              ((0x00f6  << 2) + 0xfe037000)
  //31:27  not used. always 0.
  //26:24  not used. always 0.
...
#define DMC_RANK0_ADDRMAP_0                        ((0x0101  << 2) + 0xfe037000)
  //29:25 ca8.
  //24:20 ca7.
  //19:15 ca6.
  //14:10 ca5.
...
#define DMC_RANK0_ADDRMAP_1                        ((0x0102  << 2) + 0xfe037000)
  //29:25 ra2.
  //24:20 ra1.
  //19:15 ra0.
  //14:10 ca11.
...
#define DMC_RANK0_ADDRMAP_2                        ((0x0103  << 2) + 0xfe037000)
  //29:25 ra8.
  //24:20 ra7.
  //19:15 ra6.
  //14:10 ra5.
...
#define DMC_RANK0_ADDRMAP_3                        ((0x0104  << 2) + 0xfe037000)
  //29:25 ra14.
  //24:20 ra13.
  //19:15 ra12.
  //14:10 ra11.
...
#define DMC_RANK0_ADDRMAP_4                        ((0x0105  << 2) + 0xfe037000)
...
#define DMC_RANK1_ADDRMAP_0                        ((0x0106  << 2) + 0xfe037000)
  //29:25 ca8.
  //24:20 ca7.
  //19:15 ca6.
  //14:10 ca5.
...
#define DMC_RANK1_ADDRMAP_1                        ((0x0107  << 2) + 0xfe037000)
  //29:25 ra2.
  //24:20 ra1.
  //19:15 ra0.
  //14:10 ca11.
...
#define DMC_RANK1_ADDRMAP_2                        ((0x0108  << 2) + 0xfe037000)
  //29:25 ra8.
  //24:20 ra7.
  //19:15 ra6.
  //14:10 ra5.
...
#define DMC_RANK1_ADDRMAP_3                        ((0x0109  << 2) + 0xfe037000)
  //29:25 ra14.
  //24:20 ra13.
  //19:15 ra12.
  //14:10 ra11.
...
#define DMC_RANK1_ADDRMAP_4                        ((0x010a  << 2) + 0xfe037000)
  //29:25 ra16 for DDR4 SDRAM
  //24:20 bg1  for DDR4 SDRAM.
...
#define DDR_APB_SEC_CTRL0                          ((0x010c  << 2) + 0xfe037000)
...
#define DDR_APB_SEC_CTRL9                          ((0x0115  << 2) + 0xfe037000)
...
//
// -----------------------------------------------
// REG_BASE:  DMC_REG_BASE = 0xfe036000
// -----------------------------------------------
...
#define DMC_MON0_CTRL                              ((0x0030  << 2) + 0xfe036000)
...
#define DMC_MON0_CTRL1                             ((0x0031  << 2) + 0xfe036000)
...
#define DMC_AXI0_CHAN_STS                          ((0x0083  << 2) + 0xfe036000)
...
//  //bit  7.  IRQ/FIQ control enable.
//  //bit  6:0.  not used.
#define DMC_AXI1_CHAN_STS                          ((0x0087  << 2) + 0xfe036000)
...
//    //15:8 read hold num.   max outstanding request number.
//    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI2_CHAN_STS                          ((0x008a  << 2) + 0xfe036000)
...
#define DMC_AXI3_HOLD_CTRL                         ((0x008d  << 2) + 0xfe036000)
    ...
    //15:8 read hold num.   max outstanding request number.
    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI3_CHAN_STS                          ((0x008e  << 2) + 0xfe036000)
...
#define DMC_AXI4_HOLD_CTRL                         ((0x0091  << 2) + 0xfe036000)
    ...
    //15:8 read hold num.   max outstanding request number.
    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI4_CHAN_STS                          ((0x0092  << 2) + 0xfe036000)
...
#define DMC_AXI5_HOLD_CTRL                         ((0x0095  << 2) + 0xfe036000)
    ...
    //15:8 read hold num.   max outstanding request number.
    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI5_CHAN_STS                          ((0x0096  << 2) + 0xfe036000)
...
//    //15:8 read hold num.   max outstanding request number.
//    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI6_CHAN_STS                          ((0x009a  << 2) + 0xfe036000)
...
#define DMC_AXI7_HOLD_CTRL                         ((0x009d  << 2) + 0xfe036000)
    ...
    //15:8 read hold num.   max outstanding request number.
    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI7_CHAN_STS                          ((0x009e  << 2) + 0xfe036000)
...
//    //15:8 read hold num.   max outstanding request number.
//    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI8_CHAN_STS                          ((0x00a2  << 2) + 0xfe036000)
//
//
...
//    //15:8 read hold num.   max outstanding request number.
//    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI9_CHAN_STS                          ((0x00a6  << 2) + 0xfe036000)
//
//
...
//  //bit  7.  IRQ/FIQ control enable.
//  //bit  6:0.  not used.
#define DMC_AXI10_CHAN_STS                         ((0x00ab  << 2) + 0xfe036000)
...
#define DMC_AXI11_HOLD_CTRL                        ((0x00ad  << 2) + 0xfe036000)
    ...
    //15:8 read hold num.   max outstanding request number.
    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI11_CHAN_STS                         ((0x00ae  << 2) + 0xfe036000)
...
//    //15:8 read hold num.   max outstanding request number.
//    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI12_CHAN_STS                         ((0x00b2  << 2) + 0xfe036000)
...
//    //15:8 read hold num.   max outstanding request number.
//    //7:0  read hold release num. if the outstanding request == hold num, then hold this request unless the outstanding request number bellow the hold release number, then continue to request.
#define DMC_AXI13_CHAN_STS                         ((0x00b6  << 2) + 0xfe036000)
#define DMC_CHAN_STS                               ((0x00b7  << 2) + 0xfe036000)
...
#define DMC_IRQ_STS                                ((0x00c0  << 2) + 0xfe036000)
  //bit 31:3   Not used.
...
// -----------------------------------------------
// REG_BASE:  DMC_TEST_REG_BASE = 0xfe037800
// -----------------------------------------------
...
//
// -----------------------------------------------
// REG_BASE:  DMC_DRAM_REG_BASE = 0xfe036400
// -----------------------------------------------
...
#define DMC_DRAM_TPBR                              ((0x003e  << 2) + 0xfe036400)
  //bit 23:16 tPBR2ACT
  //bit 7:0   tPBR2PBR
...
#define DMC_NFQ_TPBR                               ((0x007e  << 2) + 0xfe036400)
#define DMC_NFQ_TCSH                               ((0x007f  << 2) + 0xfe036400)
...
#define DMC_OSC_CTRL                               ((0x0098  << 2) + 0xfe036400)
...
#define DMC_TEMP_CTRL                              ((0x0099  << 2) + 0xfe036400)
//bit 31  mr temp read control.
//bit 23:0 counter value in t100NS.

#define DMC_TEMP_CTRL1                             ((0x009a  << 2) + 0xfe036400)
//bit 7:0  mr index.
...
#define DMC_LP2_TIMER                              ((0x009c  << 2) + 0xfe036400)
//Not used.
...
#define DMC_DRAM_TOSCPD                            ((0x00b0  << 2) + 0xfe036400)
#define DMC_DRAM_TCKMAX                            ((0x00b1  << 2) + 0xfe036400)
#define DMC_DRAM_TPPD                              ((0x00b2  << 2) + 0xfe036400)
 //7:0  tclk(max).    100ns in LPDDR4.

#define DMC_NFQ_TOSCPD                             ((0x00c0  << 2) + 0xfe036400)
#define DMC_NFQ_TCKMAX                             ((0x00c1  << 2) + 0xfe036400)
#define DMC_NFQ_TPPD                               ((0x00c2  << 2) + 0xfe036400)
...
#define DMC_DRAM_MRR0                              ((0x00d7  << 2) + 0xfe036400)
 //7:0  the 1st MR read result for snoop
#define DMC_DRAM_MRR1                              ((0x00d8  << 2) + 0xfe036400)
...
//
// -----------------------------------------------
// REG_BASE:  DMC_STICKY_REG_BASE = 0xfe036800
// -----------------------------------------------
