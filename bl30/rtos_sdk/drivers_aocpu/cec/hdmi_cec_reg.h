...
#define WAKEUP_EN_MASK (WAKEUP_OP_86_EN | WAKEUP_OP_0D_EN | WAKEUP_OP_04_EN)
...
#define CEC_OC_POLLING_MESSAGE                                                                     \
	0xFC /* Fake Code - <Poll Message> has no OP Code and requires only the header byte */
...
struct cec_msg {
	struct cec_msg_buf buf[2]; /* message memory */
