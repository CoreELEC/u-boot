...
extern struct lcd_phy_ctrl_s *lcd_phy_ctrl;

void lcd_phy_config_init_c3(struct aml_lcd_data_s *pdata);
void lcd_phy_config_init_g12a(struct aml_lcd_data_s *pdata);
void lcd_phy_config_init_t3_t5m(struct aml_lcd_data_s *pdata);
void lcd_phy_config_init_t5(struct aml_lcd_data_s *pdata);
void lcd_phy_config_init_t5w(struct aml_lcd_data_s *pdata);
void lcd_phy_config_init_t7(struct aml_lcd_data_s *pdata);
void lcd_phy_config_init_tl1(struct aml_lcd_data_s *pdata);
