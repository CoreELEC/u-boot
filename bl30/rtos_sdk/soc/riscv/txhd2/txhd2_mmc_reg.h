...
// Project name: txhd2
//
// Create time: Mon Feb 13 20:40:18 CST 2023 by chong.gu
//
// ./mmc_reg.vh
//
// DO NOT EDIT!!!!!
...
#define DMC_VIO_ADDR3                              ((0x00f6  << 2) + 0xff639000)
  ...
  //20     not used.
  //19     not used.
  //18     ddr0 read address overflow. write out of DDR size.
  //17:15  ddr0 read violation ARPROT bits.
  //14:0   ddr0_read violation ID.
...
#define DMC_RANK0_ADDRMAP_0                        ((0x0101  << 2) + 0xff639000)
  //29:25 ca8.
  //24:20 ca7.
  //19:15 ca6.
  //14:10 ca5.
...
#define DMC_RANK0_ADDRMAP_1                        ((0x0102  << 2) + 0xff639000)
  //29:25 ra2.
  //24:20 ra1.
  //19:15 ra0.
  //14:10 ca11.
...
#define DMC_RANK0_ADDRMAP_2                        ((0x0103  << 2) + 0xff639000)
  //29:25 ra8.
  //24:20 ra7.
  //19:15 ra6.
  //14:10 ra5.
...
#define DMC_RANK0_ADDRMAP_3                        ((0x0104  << 2) + 0xff639000)
  //29:25 ra14.
  //24:20 ra13.
  //19:15 ra12.
  //14:10 ra11.
...
#define DMC_RANK0_ADDRMAP_4                        ((0x0105  << 2) + 0xff639000)
...
#define DMC_RANK1_ADDRMAP_0                        ((0x0106  << 2) + 0xff639000)
  //29:25 ca8.
  //24:20 ca7.
  //19:15 ca6.
  //14:10 ca5.
...
#define DMC_RANK1_ADDRMAP_1                        ((0x0107  << 2) + 0xff639000)
  //29:25 ra2.
  //24:20 ra1.
  //19:15 ra0.
  //14:10 ca11.
...
#define DMC_RANK1_ADDRMAP_2                        ((0x0108  << 2) + 0xff639000)
  //29:25 ra8.
  //24:20 ra7.
  //19:15 ra6.
  //14:10 ra5.
...
#define DMC_RANK1_ADDRMAP_3                        ((0x0109  << 2) + 0xff639000)
  //29:25 ra14.
  //24:20 ra13.
  //19:15 ra12.
  //14:10 ra11.
...
#define DMC_RANK1_ADDRMAP_4                        ((0x010a  << 2) + 0xff639000)
  //29:25 ra16 for DDR4 SDRAM
  //24:20 bg1  for DDR4 SDRAM.
...
#define DMC_DRAM_TPBR                              ((0x003e  << 2) + 0xff638400)
  //bit 23:16 tPBR2ACT
  //bit 7:0   tPBR2PBR
...
#define DMC_NFQ_TPBR                               ((0x007e  << 2) + 0xff638400)
#define DMC_NFQ_TCSH                               ((0x007f  << 2) + 0xff638400)
...
#define DMC_OSC_CTRL                               ((0x0098  << 2) + 0xff638400)
...
#define DMC_TEMP_CTRL                              ((0x0099  << 2) + 0xff638400)
//bit 31  mr temp read control.
//bit 23:0 counter value in t100NS.

#define DMC_TEMP_CTRL1                             ((0x009a  << 2) + 0xff638400)
//bit 7:0  mr index.
...
#define DMC_LP2_TIMER                              ((0x009c  << 2) + 0xff638400)
//Not used.
...
#define DMC_DRAM_TOSCPD                            ((0x00b0  << 2) + 0xff638400)
#define DMC_DRAM_TCKMAX                            ((0x00b1  << 2) + 0xff638400)
#define DMC_DRAM_TPPD                              ((0x00b2  << 2) + 0xff638400)
 //7:0  tclk(max).    100ns in LPDDR4.

#define DMC_NFQ_TOSCPD                             ((0x00c0  << 2) + 0xff638400)
#define DMC_NFQ_TCKMAX                             ((0x00c1  << 2) + 0xff638400)
#define DMC_NFQ_TPPD                               ((0x00c2  << 2) + 0xff638400)
...
#define DMC_DRAM_MRR0                              ((0x00d7  << 2) + 0xff638400)
 //7:0  the 1st MR read result for snoop
#define DMC_DRAM_MRR1                              ((0x00d8  << 2) + 0xff638400)
...
// -----------------------------------------------
// REG_BASE:  DMC_FREQ_REG_BASE = 0xfe00e000
// -----------------------------------------------
//        REGISTER_BASE_ADDR  32'hfe00e000
//
//              |               |            |---------->  1/(OD,OD1) -->ddr_dpll_clk_out_a
//  VCO ------> |  1/ reve[5:4] | --VCO_A--->|
//              |               |            |----inv--->  1/(OD,OD1) -->ddr_dpll_clk_out_b
#define AM_DDR_PLL_CNTL0                           ((0x0000  << 2) + 0xfe00e000)
  //bit 31    : dpll_lock
  //bit 29    : dpll_reset.
  //bit 28    : dpll_en.
...
#define AM_DDR_PLL_CNTL1                           ((0x0001  << 2) + 0xfe00e000)
  //bit 18:0    : ddr_dpll_frac
#define AM_DDR_PLL_CNTL2                           ((0x0002  << 2) + 0xfe00e000)
  //bit 22:20  : fref_sel
  //bit 17:16  : os_ssc
  //bit 15:12  : ssc_str_m
  //bit 8      : ssc_en
...
#define AM_DDR_PLL_CNTL3                           ((0x0003  << 2) + 0xfe00e000)
  //bit 31     : afc bypass
  //bit 30     : afc clk sel
  //bit 29     : code new
  //bit 28     : dco_m_en
...
#define AM_DDR_PLL_CNTL4                           ((0x0004  << 2) + 0xfe00e000)
  //bit 1:0    : pfd_gain
  //bit 7:4    : filter_pvt1
  ...
  //bit 27:24  : rou
  //bit 31:28  : alpha
#define AM_DDR_PLL_CNTL5                           ((0x0005  << 2) + 0xfe00e000)
  //bit
...
#define AM_DDR_PLL_CNTL6                           ((0x0006  << 2) + 0xfe00e000)
...
#define AM_DDR_PLL_STS                             ((0x0007  << 2) + 0xfe00e000)
  //bit 31     : DDR_PLL_LOCK
  //bit 30     : lock_a
  //bit 29     : afc_done
...
#define AM_DDR_CLK_CNTL                            ((0x0008  << 2) + 0xfe00e000)
...
#define AM_DDR_PHY_CTRL                            ((0x0009  << 2) + 0xfe00e000)
...
#define AM_DDR_FREQ_CTRL                           ((0x000c  << 2) + 0xfe00e000)
