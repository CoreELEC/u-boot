...
#define CMD_SPI_DEV		0xFA
#define CMD_SPI_XFER		0xFB
...
#define MBX_CMD_SPI_DEV __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SPI_DEV)
#define MBX_CMD_SPI_XFER __MBX_COMPOSE_MSG(MBX_SYSTEM, CMD_SPI_XFER)
