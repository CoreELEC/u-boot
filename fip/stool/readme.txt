...
|  |-2. for those project which use aml_encrypt_gxl/txlx/g12a/g12b/tl1/tm2 etc for secure boot, please use following mapping table for key transfer
...
|  |             -s soc              //soc type: gxl,txlx,g12a,g12b,tl1,tm2
...
|   |    |  signing-tool-g12a-dev or signing-tool-tl1-dev, current version only support gxl/txlx/g12a/g12b/tl1/tm2
...
|               --soc [gxl | txlx | g12a | g12b | tl1 | tm2 ] \          //soc type, must afford
