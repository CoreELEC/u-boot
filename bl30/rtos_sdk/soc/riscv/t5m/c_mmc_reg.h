...
// Project name: t5m
// 
// Create time: Wed Jul 27 13:38:09 CST 2022 by leilei.ge
// 
// ../mmc/dmc_v23/rtl/dmc_reg.vh
// 
// DO NOT EDIT!!!!!
// ----------------------------------------------------------------------
// 
...
//
// Reading file:  ../mmc/dmc_v23/rtl/dmc_reg.vh
//
...
#define DMC_REQ_CTRL                               0x0000
  //bit 7.   enable dmc request of axibus chan 7.  NIC4 include NNA debus, dsp, aocpu, audio, dmc, etc.
...
#define DMC_AXI2_CHAN_CTRL1                        0x008a
   ...
   //bit 28:20. when write/read side band singal used to block other request. configure which master we can block. each bit for  one master.
                //Note. don't block vpu itslef and  CPU or other urgent request.
...
#define DMC_DRAM_MCFG1                             0x0188
 ...
 //bit 21;  enable seperate dfi_lp_data_req. 1: enable. 0: dfi_lp_data_req same as dfi_lp_ctrl_req.
...
#define DMC_PHY_RETRAINING_CTRL                    0x0197
  ...
  //bit 29 :  retrain_only 1: use full 28:24 as retrain dfi_freq value 0: use only 28:27 + origh dfi_freq2:0 as the retrain dfi_freq.
...
//DMC use 15bits ARUSER/AWUSER bits to identify AXI input ports master ID and secruity requirement and the necessory subID for bandwidth monitor protection functions. .  
//bit 7:0.   for upto 256 Master-ID.
//bit  14:8.  for each Master-ID, the master can use those bits to define particular secrity requirments or bandwith and protection function special requirements. 
...
#define DMC_SEC_RANGE8_CTRL                        0x0482
  ...
  //bit 1  | 0 | range_key_sel | range 0 data describle key selection.  1 : key1. 0 : key0.
...
#define DMC_SEC_RANGE13_CTRL                       0x04d2
  ...
  //bit 1   range_key_sel,  range 0 data describle key selection.  1 : key1. 0 : key0.
...
#define DMC_AXI2DDR0                               0x0520
  ...
  //bit 3  16bit in 32bit DDR SDRAM for unbalance mode. 
  //bit 2  not used. 
...
#define DMC_DDR_CTRL1                              0x0541
  ...
  //bit 30~3. not used.
  //bit 6.  strict security level control for DMA channel. 1: only sec level input == region sec level is allowded.  0:  sec_level input >= region sec level is allow to write. 
...
//
// Closing file:  ../mmc/dmc_v23/rtl/dmc_reg.vh
//
