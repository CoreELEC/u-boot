...
static unsigned int pll_ss_level_table[][2] = {
	/* dep_sel,  str_m  */
	{ 0,          0}, /* 0: disable */
	{ 4,          1}, /* 1: +/-0.1% */
	{ 4,          2}, /* 2: +/-0.2% */
...
static void lcd_set_pll_ss_level(struct aml_lcd_drv_s *pdrv)
{
	...
	if (level > 0) {
		cconf->ss_en = 1;
		dep_sel = pll_ss_level_table[level][0];
		str_m = pll_ss_level_table[level][1];
...
static void lcd_set_tcon_pll_clk(struct aml_lcd_drv_s *pdrv)
{
...
static void lcd_clk_frac_update(struct aml_lcd_drv_s *pdrv)
{
	struct lcd_clk_config_s *cconf;
	...
	lcd_ana_setb(reg, cconf->pll_frac, 0, 17);
	if (lcd_debug_print_flag & LCD_DBG_PR_NORMAL) {
...
static void lcd_clk_disable(struct aml_lcd_drv_s *pdrv)
{
	...
	lcd_clk_setb(HHI_VIID_CLK_CNTL, 0, VCLK2_EN, 1);
	//pll disable
	lcd_ana_setb(HHI_TCON_PLL_CNTL0, 0, 28, 1);
	//pll rst
...
static struct lcd_clk_data_s lcd_clk_data_t5 = {
	...
	.pll_od_sel_max = 3,
	.pll_ref_fmax = (25 * 1000),  //khz
	.pll_ref_fmin = (5 * 1000),   //khz
	.pll_vco_fmax = (6000 * 1000),  //khz
	.pll_vco_fmin = (3000 * 1000),  //khz
	.pll_out_fmax = (3100 * 1000),  //khz
	.pll_out_fmin = (3384 * 1000) / 16,  //khz
	.div_in_fmax = (3100 * 1000),   //khz
	.div_out_fmax = (3100 * 1000),  //khz
	.xd_out_fmax = (750 * 1000),    //khz
	...
	.clk_frac_update = lcd_clk_frac_update,
