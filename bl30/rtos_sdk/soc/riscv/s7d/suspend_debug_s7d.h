...
#ifndef __SUSPEND_DEBUG_S7D_H__
#define __SUSPEND_DEBUG_S7D_H__
...
static inline void show_pwm_regs(void)
{
	...
	if (IS_EN(BL30_SHOW_PWM_VOLT)) {
		...
		printf("CLKCTRL_PWM_CLK_GH_CTRL 0x%x\n", REG32(CLKCTRL_PWM_CLK_GH_CTRL));
...
{
	/* for s7d, have core0~3 and cpu_top */
