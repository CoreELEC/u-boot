...
extern int v2_usbburning(unsigned int timeout);
...
extern unsigned int _get_romcode_boot_id(void);
#else
static unsigned int _get_romcode_boot_id(void)
{
