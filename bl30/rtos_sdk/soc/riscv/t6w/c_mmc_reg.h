...
//Total dmc number: 1
//dmc0 base address: 0xfe340000
#define MMC0_Wr(addr, data) *(volatile uint32_t *)((addr<<2)+0xfe340000)=(data)
#define MMC0_Rd(addr) *(volatile uint32_t *)((addr<<2)+0xfe340000)

//
// Reading file:  ../dmc_v28/rtl/dmc_reg.vh
//

// -----------------------------------------------
// REG_BASE:  DMC_FREQ_REG_BASE = 0xfe340000
// -----------------------------------------------
//        REGISTER_BASE_ADDR  32'hfe340000
...
#define DMC_CMD_FILTER_CTRL3                       0x0043
...
#define DMC_CMD_FILTER_CTRL4                       0x0044
...
#define DMC_CMD_FILTER_CTRL5                       0x0045
...
#define DMC_CMD_FILTER_CTRL6                       0x0046
...
#define DMC_CMD_FILTER_CTRL7                       0x0047
...
#define DMC_CMD_FILTER_CTRL8                       0x0048
...
#define DMC_CMD_BUFFER_CTRL                        0x0049
...
#define DMC_CMD_BUFFER_CTRL1                       0x004a
...
#define AXI_ARB0_SEL                               0x004b
  //bit 8. write 1 to make axi master 8 select mdc 0 to route its requests.
  //bit 7. write 1 to make axi master 7 select mdc 0 to route its requests.
  //bit 6. write 1 to make axi master 6 select mdc 0 to route its requests.
  //bit 5. write 1 to make axi master 5 select mdc 0 to route its requests.
  //bit 4. write 1 to make axi master 4 select mdc 0 to route its requests.
  //bit 3. write 1 to make axi master 3 select mdc 0 to route its requests.
  //bit 2. write 1 to make axi master 2 select mdc 0 to route its requests.
  //bit 1. write 1 to make axi master 1 select mdc 0 to route its requests.
  //bit 0. write 1 to make axi master 0 select mdc 0 to route its requests.
...
#define DMC_AXI1_CHAN_CTRL1                        0x0087
   ...
   //bit 30:25. not used.
   //bit 24:16. when write/read side band signal used to block other request. configure which master we can block. each bit for  one master.
   ...
   //bit 9.    use side band write urgent control signal to block other master request.  1: enable. 0 disable.
   //bit 8.    use side band read urgent control signal to block other master request.  1: enable. 0 disable.
...
#define DMC_AXI9_CHAN_CTRL                         0x00b0
#define DMC_AXI9_HOLD_CTRL                         0x00b1
#define DMC_AXI9_CHAN_CTRL1                        0x00b2
#define DMC_AXI9_CHAN_STS                          0x00b3

#define DMC_AXI10_CHAN_CTRL                        0x00b5
#define DMC_AXI10_HOLD_CTRL                        0x00b6
#define DMC_AXI10_CHAN_CTRL1                       0x00b7
#define DMC_AXI10_CHAN_STS                         0x00b8

#define DMC_AXI11_CHAN_CTRL                        0x00ba
#define DMC_AXI11_HOLD_CTRL                        0x00bb
#define DMC_AXI11_CHAN_CTRL1                       0x00bc
#define DMC_AXI11_CHAN_STS                         0x00bd
...
//bit 31 .  chan0 write 1 to change frequency   read 0: finished.
...
#define DMC_DRAM1_TEMP_CTRL1                       0x019f
//bit 31   mr auto read change irq, 2 channel clear (level)
//bit 30   mrr_diff_irq0
//bit 27   mrr1_diff
//bit 26   mrr0_diff
...
#define DMC_DRAM1_MRR0                             0x01c7
 //31:16 the 1st MR read result mask
 //15:0  the 1st MR read result for snoop
#define DMC_DRAM1_MRR1                             0x01c8
 //31:16 the 2nd MR read result mask
 //15:0  the 2nd MR read result for snoop
...
//*************************************************
//12'h300 ~ 12'h3ff for dmc_freq_clk apb register
//*************************************************
...
#define DMC_SEC_RANGE16_STA                        0x0500
#define DMC_SEC_RANGE16_EDA                        0x0501
#define DMC_SEC_RANGE16_CTRL                       0x0502
#define DMC_SEC_RANGE16_RID_CTRL0                  0x0503
#define DMC_SEC_RANGE16_RID_CTRL1                  0x0504
#define DMC_SEC_RANGE16_WID_CTRL0                  0x0508
#define DMC_SEC_RANGE16_WID_CTRL1                  0x0509

//region17(RANGE11) related register.
#define DMC_SEC_RANGE17_STA                        0x0510
#define DMC_SEC_RANGE17_EDA                        0x0511
#define DMC_SEC_RANGE17_CTRL                       0x0512
#define DMC_SEC_RANGE17_RID_CTRL0                  0x0513
#define DMC_SEC_RANGE17_RID_CTRL1                  0x0514
#define DMC_SEC_RANGE17_WID_CTRL0                  0x0518
#define DMC_SEC_RANGE17_WID_CTRL1                  0x0519

//region18(RANGE12) related register.
#define DMC_SEC_RANGE18_STA                        0x0520
#define DMC_SEC_RANGE18_EDA                        0x0521
#define DMC_SEC_RANGE18_CTRL                       0x0522
#define DMC_SEC_RANGE18_RID_CTRL0                  0x0523
#define DMC_SEC_RANGE18_RID_CTRL1                  0x0524
#define DMC_SEC_RANGE18_WID_CTRL0                  0x0528
#define DMC_SEC_RANGE18_WID_CTRL1                  0x0529

//region19(RANGE13) related register.
#define DMC_SEC_RANGE19_STA                        0x0530
#define DMC_SEC_RANGE19_EDA                        0x0531
#define DMC_SEC_RANGE19_CTRL                       0x0532
#define DMC_SEC_RANGE19_RID_CTRL0                  0x0533
#define DMC_SEC_RANGE19_RID_CTRL1                  0x0534
#define DMC_SEC_RANGE19_WID_CTRL0                  0x0538
#define DMC_SEC_RANGE19_WID_CTRL1                  0x0539

//region20(RANGE14) related register.
#define DMC_SEC_RANGE20_STA                        0x0540
#define DMC_SEC_RANGE20_EDA                        0x0541
#define DMC_SEC_RANGE20_CTRL                       0x0542
#define DMC_SEC_RANGE20_RID_CTRL0                  0x0543
#define DMC_SEC_RANGE20_RID_CTRL1                  0x0544
#define DMC_SEC_RANGE20_WID_CTRL0                  0x0548
#define DMC_SEC_RANGE20_WID_CTRL1                  0x0549

//region21(RANGE15) related register.
#define DMC_SEC_RANGE21_STA                        0x0550
#define DMC_SEC_RANGE21_EDA                        0x0551
#define DMC_SEC_RANGE21_CTRL                       0x0552
#define DMC_SEC_RANGE21_RID_CTRL0                  0x0553
#define DMC_SEC_RANGE21_RID_CTRL1                  0x0554
#define DMC_SEC_RANGE21_WID_CTRL0                  0x0558
#define DMC_SEC_RANGE21_WID_CTRL1                  0x0559

//region22(RANGE16) related register.
#define DMC_SEC_RANGE22_STA                        0x0560
#define DMC_SEC_RANGE22_EDA                        0x0561
#define DMC_SEC_RANGE22_CTRL                       0x0562
#define DMC_SEC_RANGE22_RID_CTRL0                  0x0563
#define DMC_SEC_RANGE22_RID_CTRL1                  0x0564
#define DMC_SEC_RANGE22_WID_CTRL0                  0x0568
#define DMC_SEC_RANGE22_WID_CTRL1                  0x0569

//region23(RANGE17) related register.
#define DMC_SEC_RANGE23_STA                        0x0570
#define DMC_SEC_RANGE23_EDA                        0x0571
#define DMC_SEC_RANGE23_CTRL                       0x0572
#define DMC_SEC_RANGE23_RID_CTRL0                  0x0573
#define DMC_SEC_RANGE23_RID_CTRL1                  0x0574
#define DMC_SEC_RANGE23_WID_CTRL0                  0x0578
#define DMC_SEC_RANGE23_WID_CTRL1                  0x0579

//region24(RANGE18) related register.
#define DMC_SEC_RANGE24_STA                        0x0580
#define DMC_SEC_RANGE24_EDA                        0x0581
#define DMC_SEC_RANGE24_CTRL                       0x0582
#define DMC_SEC_RANGE24_RID_CTRL0                  0x0583
#define DMC_SEC_RANGE24_RID_CTRL1                  0x0584
#define DMC_SEC_RANGE24_WID_CTRL0                  0x0588
#define DMC_SEC_RANGE24_WID_CTRL1                  0x0589

//region25(RANGE19) related register.
#define DMC_SEC_RANGE25_STA                        0x0590
#define DMC_SEC_RANGE25_EDA                        0x0591
#define DMC_SEC_RANGE25_CTRL                       0x0592
#define DMC_SEC_RANGE25_RID_CTRL0                  0x0593
#define DMC_SEC_RANGE25_RID_CTRL1                  0x0594
#define DMC_SEC_RANGE25_WID_CTRL0                  0x0598
#define DMC_SEC_RANGE25_WID_CTRL1                  0x0599

//region26(RANGE1A) related register.
#define DMC_SEC_RANGE26_STA                        0x05a0
#define DMC_SEC_RANGE26_EDA                        0x05a1
#define DMC_SEC_RANGE26_CTRL                       0x05a2
#define DMC_SEC_RANGE26_RID_CTRL0                  0x05a3
#define DMC_SEC_RANGE26_RID_CTRL1                  0x05a4
#define DMC_SEC_RANGE26_WID_CTRL0                  0x05a8
#define DMC_SEC_RANGE26_WID_CTRL1                  0x05a9

//region27(RANGE1B) related register.
#define DMC_SEC_RANGE27_STA                        0x05b0
#define DMC_SEC_RANGE27_EDA                        0x05b1
#define DMC_SEC_RANGE27_CTRL                       0x05b2
#define DMC_SEC_RANGE27_RID_CTRL0                  0x05b3
#define DMC_SEC_RANGE27_RID_CTRL1                  0x05b4
#define DMC_SEC_RANGE27_WID_CTRL0                  0x05b8
#define DMC_SEC_RANGE27_WID_CTRL1                  0x05b9

//region28(RANGE1C) related register.
#define DMC_SEC_RANGE28_STA                        0x05c0
#define DMC_SEC_RANGE28_EDA                        0x05c1
#define DMC_SEC_RANGE28_CTRL                       0x05c2
#define DMC_SEC_RANGE28_RID_CTRL0                  0x05c3
#define DMC_SEC_RANGE28_RID_CTRL1                  0x05c4
#define DMC_SEC_RANGE28_WID_CTRL0                  0x05c8
#define DMC_SEC_RANGE28_WID_CTRL1                  0x05c9

//region29(RANGE1D) related register.
#define DMC_SEC_RANGE29_STA                        0x05d0
#define DMC_SEC_RANGE29_EDA                        0x05d1
#define DMC_SEC_RANGE29_CTRL                       0x05d2
#define DMC_SEC_RANGE29_RID_CTRL0                  0x05d3
#define DMC_SEC_RANGE29_RID_CTRL1                  0x05d4
#define DMC_SEC_RANGE29_WID_CTRL0                  0x05d8
#define DMC_SEC_RANGE29_WID_CTRL1                  0x05d9

//region30(RANGE1E) related register.
#define DMC_SEC_RANGE30_STA                        0x05e0
#define DMC_SEC_RANGE30_EDA                        0x05e1
#define DMC_SEC_RANGE30_CTRL                       0x05e2
#define DMC_SEC_RANGE30_RID_CTRL0                  0x05e3
#define DMC_SEC_RANGE30_RID_CTRL1                  0x05e4
#define DMC_SEC_RANGE30_WID_CTRL0                  0x05e8
#define DMC_SEC_RANGE30_WID_CTRL1                  0x05e9

//region31(RANGE1F) related register.
#define DMC_SEC_RANGE31_STA                        0x05f0
#define DMC_SEC_RANGE31_EDA                        0x05f1
#define DMC_SEC_RANGE31_CTRL                       0x05f2
#define DMC_SEC_RANGE31_RID_CTRL0                  0x05f3
#define DMC_SEC_RANGE31_RID_CTRL1                  0x05f4
#define DMC_SEC_RANGE31_WID_CTRL0                  0x05f8
#define DMC_SEC_RANGE31_WID_CTRL1                  0x05f9
...
#define DMC_DES_KEY0_REG0                          0x0602
#define DMC_DES_KEY0_REG1                          0x0603
#define DMC_DES_KEY0_REG2                          0x0604
#define DMC_DES_KEY0_REG3                          0x0605
#define DMC_DES_KEY1_REG0                          0x0606
#define DMC_DES_KEY1_REG1                          0x0607
#define DMC_DES_KEY1_REG2                          0x0608
#define DMC_DES_KEY1_REG3                          0x0609
...
#define DDR_APB_SEC_CTRL0                          0x0610
...
#define DDR_APB_SEC_CTRL9                          0x0619
   // APB access control for MDC register.
   //default : 0x005
   //bit 8    lock bit if this bit =  1,  this register is locked and cannot modified anymore.
   //bit 7:0.  APB access enable for each APB user ID. one ID one bit. 1: enable. 0 disable.
...
#define DMC_VIO_ADDR0                              0x061b
  //ddr0 write secure violation address[31:0].
#define DMC_VIO_ADDR1                              0x061c
  ...
  //13:0   AWID.
#define DMC_VIO_ADDR2                              0x061d
  //ddr0 read secure violation address[31:0]
#define DMC_VIO_ADDR3                              0x061e
  //31:30  not used. always 0.
...
#define DMC_AXI2DDR1                               0x0621
#define DMC_AXI2DDR2                               0x0622
#define DMC_AXI2DDR3                               0x0623
#define DMC_AXI2DDR4                               0x0624
#define DMC_AXI2DDR5                               0x0625
#define DMC_AXI2DDR6                               0x0626
#define DMC_AXI2DDR7                               0x0627
#define DMC_AXI2DDR8                               0x0628
#define DMC_AXI2DDR9                               0x0629
#define DMC_AXI2DDRA                               0x062a
#define DMC_AXI2DDRB                               0x062b
#define DMC_AXI2DDRC                               0x062c
#define DMC_AXI2DDRD                               0x062d
#define DMC_AXI2DDRE                               0x062e
#define DMC_AXI2DDRF                               0x062f

#define DMC_AXI2DDR10                              0x0630
#define DMC_AXI2DDR11                              0x0631
#define DMC_AXI2DDR12                              0x0632
#define DMC_AXI2DDR13                              0x0633
#define DMC_AXI2DDR14                              0x0634
#define DMC_AXI2DDR15                              0x0635
#define DMC_AXI2DDR16                              0x0636
#define DMC_AXI2DDR17                              0x0637
#define DMC_AXI2DDR18                              0x0638
#define DMC_AXI2DDR19                              0x0639
#define DMC_AXI2DDR1A                              0x063a
#define DMC_AXI2DDR1B                              0x063b
#define DMC_AXI2DDR1C                              0x063c
#define DMC_AXI2DDR1D                              0x063d
#define DMC_AXI2DDR1E                              0x063e
#define DMC_AXI2DDR1F                              0x063f


#define DMC_DDR_CTRL                               0x0640
...
#define DMC_RANK0_ADDRMAP_0                        0x0642
  //29:25 ca8.
  //24:20 ca7.
  //19:15 ca6.
  //14:10 ca5.
  //9:5   ca4.
  //4:0   ca3.
#define DMC_RANK0_ADDRMAP_1                        0x0643
  //29:25 ra2.
  //24:20 ra1.
  //19:15 ra0.
  //14:10 ca11.
  //9:5   ca10.
  //4:0   ca9.
#define DMC_RANK0_ADDRMAP_2                        0x0644
  //29:25 ra8.
  //24:20 ra7.
  //19:15 ra6.
  //14:10 ra5.
  //9:5   ra4.
  //4:0   ra3.
#define DMC_RANK0_ADDRMAP_3                        0x0645
  //29:25 ra14.
  //24:20 ra13.
  //19:15 ra12.
  //14:10 ra11.
  //9:5   ra10.
  //4:0   ra9.
#define DMC_RANK0_ADDRMAP_4                        0x0646
  //29:25 ra16
  //24:20 bg1
  //19:15 ba2.
  //14:10 ba1.
  //9:5   ba0.
  //4:0   ra15.
#define DMC_RANK1_ADDRMAP_0                        0x0648
#define DMC_RANK1_ADDRMAP_1                        0x0649
#define DMC_RANK1_ADDRMAP_2                        0x064a
#define DMC_RANK1_ADDRMAP_3                        0x064b
#define DMC_RANK1_ADDRMAP_4                        0x064c

//DMC SECURE CHECK TABLE
#define DMC_TBL_KEY_SEL                            0x0660
 //bit 31: : reserved
 //bit 7 :4 :sec_tbl_reg_offset. each 32 reg offset. real reg addr = 32*offset+12'h660, 16*32=512.
 //bit 3 : reserved
 //bit 2 : tbl_sec_vid_key_sel
 //bit 1 : tbl_nonsec_vid_key_sel
 //bit 0 : tbl_reg_lock

#define DMC_SEC_TBL0_CTRL                          0x0661
...
#define DMC_SEC_TBL1_CTRL                          0x0662
...
#define DMC_SEC_TBL_SEC_WID_CTRL1                  0x0671
 //bit 31:0 : tbl_sec_wid_ctrl[63:32]
#define DMC_SEC_TBL_SEC_WID_CTRL2                  0x0672
 //bit 31:0 : tbl_sec_wid_ctrl[95:64]
#define DMC_SEC_TBL_SEC_WID_CTRL3                  0x0673
 //bit 31:0 : tbl_sec_wid_ctrl[127:96]

#define DMC_SEC_TBL_NONSEC_WID_CTRL0               0x0674
...
#define DMC_SEC_TBL_NONSEC_WID_CTRL1               0x0675
 //bit 31:0 : tbl_nonsec_wid_ctrl[63:32]
#define DMC_SEC_TBL_NONSEC_WID_CTRL2               0x0676
 //bit 31:0 : tbl_nonsec_wid_ctrl[95:64]
#define DMC_SEC_TBL_NONSEC_WID_CTRL3               0x0677
 //bit 31:0 : tbl_nonsec_wid_ctrl[127:96]

#define DMC_SEC_TBL_SEC_RID_CTRL0                  0x0678
...
#define DMC_SEC_TBL_SEC_RID_CTRL1                  0x0679
 //bit 31:0 : tbl_sec_rid_ctrl[63:32]
#define DMC_SEC_TBL_SEC_RID_CTRL2                  0x067a
 //bit 31:0 : tbl_sec_rid_ctrl[95:64]
#define DMC_SEC_TBL_SEC_RID_CTRL3                  0x067b
 //bit 31:0 : tbl_sec_rid_ctrl[127:96]

#define DMC_SEC_TBL_NONSEC_RID_CTRL0               0x067c
...
#define DMC_SEC_TBL_NONSEC_RID_CTRL1               0x067d
 //bit 31:0 : tbl_nonsec_rid_ctrl[63:32]
#define DMC_SEC_TBL_NONSEC_RID_CTRL2               0x067e
 //bit 31:0 : tbl_nonsec_rid_ctrl[95:64]
#define DMC_SEC_TBL_NONSEC_RID_CTRL3               0x067f
...
#define DMC_SEC_TBL_REG_CFG                        0x06a0
  //bit 31:12. not used.
  //bit 11:8.  each 32 reg offset. real reg addr = 32*offset+12'h680, 16*32=512.
  //bit 7:1.   not used.
...
#define DMC_TEST_CTRL                              0x0752
   ...
   //bit 26.  remap_en. remap addr 3.5G~4G to 4~4.5G.  1 enable remap.  0: not remap.
...
#define DMC_TEST_WRCMD_ADDR                        0x0743
  //read only. the current write cmd address.
#define DMC_TEST_RDCMD_ADDR                        0x0744
   //read only. the current read command address.
#define DMC_TEST_RDRSP_ADDR                        0x0745
  //read only. the failed read response address(for error data )

//MDC REG 12'h800~12'h8ff
#define RG_MDC_0000                                0x0800
#define RG_MDC_0004                                0x0801
#define RG_MDC_0008                                0x0802
#define RG_MDC_000C                                0x0803
#define RG_MDC_0010                                0x0804
#define RG_MDC_0014                                0x0805
#define RG_MDC_0018                                0x0806
#define RG_MDC_001C                                0x0807
#define RG_MDC_0020                                0x0808
#define RG_MDC_0024                                0x0809
#define RG_MDC_0028                                0x080a
#define RG_MDC_002C                                0x080b
#define RG_MDC_0030                                0x080c
#define RG_MDC_0034                                0x080d
#define RG_MDC_0038                                0x080e
#define RG_MDC_003C                                0x080f
#define RG_MDC_0040                                0x0810
#define RG_MDC_0044                                0x0811
#define RG_MDC_0048                                0x0812
#define RG_MDC_004C                                0x0813
#define RG_MDC_0050                                0x0814
#define RG_MDC_0054                                0x0815
#define RG_MDC_0058                                0x0816
#define RG_MDC_005C                                0x0817
#define RG_MDC_0060                                0x0818
#define RG_MDC_0064                                0x0819
#define RG_MDC_0068                                0x081a
#define RG_MDC_006C                                0x081b
#define RG_MDC_0070                                0x081c
#define RG_MDC_0074                                0x081d
#define RG_MDC_0078                                0x081e
#define RG_MDC_007C                                0x081f
#define RG_MDC_0080                                0x0820
#define RG_MDC_0084                                0x0821
#define RG_MDC_0088                                0x0822
#define RG_MDC_008C                                0x0823
#define RG_MDC_0090                                0x0824
#define RG_MDC_0094                                0x0825
#define RG_MDC_0098                                0x0826
#define RG_MDC_009C                                0x0827
#define RG_MDC_00A0                                0x0828
#define RG_MDC_00A4                                0x0829
#define RG_MDC_00A8                                0x082a
#define RG_MDC_00AC                                0x082b
#define RG_MDC_00B0                                0x082c
#define RG_MDC_00B4                                0x082d
#define RG_MDC_00B8                                0x082e
#define RG_MDC_00BC                                0x082f
#define RG_MDC_00C0                                0x0830
#define RG_MDC_00C4                                0x0831
#define RG_MDC_00C8                                0x0832
#define RG_MDC_00CC                                0x0833
#define RG_MDC_00D0                                0x0834
#define RG_MDC_00D4                                0x0835
#define RG_MDC_00D8                                0x0836
#define RG_MDC_00DC                                0x0837
#define RG_MDC_00E0                                0x0838
#define RG_MDC_00E4                                0x0839
#define RG_MDC_00E8                                0x083a
#define RG_MDC_00EC                                0x083b
#define RG_MDC_00F0                                0x083c
#define RG_MDC_00F4                                0x083d
#define RG_MDC_00F8                                0x083e
#define RG_MDC_00FC                                0x083f
#define RG_MDC_0100                                0x0840
#define RG_MDC_0104                                0x0841
#define RG_MDC_0108                                0x0842
#define RG_MDC_010C                                0x0843
#define RG_MDC_0110                                0x0844
#define RG_MDC_0114                                0x0845
#define RG_MDC_0118                                0x0846
#define RG_MDC_011C                                0x0847
#define RG_MDC_0120                                0x0848
#define RG_MDC_0124                                0x0849
#define RG_MDC_0128                                0x084a
#define RG_MDC_012C                                0x084b
#define RG_MDC_0130                                0x084c
#define RG_MDC_0134                                0x084d
#define RG_MDC_0138                                0x084e
#define RG_MDC_013C                                0x084f
#define RG_MDC_0140                                0x0850
#define RG_MDC_0144                                0x0851
#define RG_MDC_0148                                0x0852
#define RG_MDC_014C                                0x0853
#define RG_MDC_0150                                0x0854
#define RG_MDC_0154                                0x0855
#define RG_MDC_0158                                0x0856
#define RG_MDC_015C                                0x0857
#define RG_MDC_0160                                0x0858
#define RG_MDC_0164                                0x0859
#define RG_MDC_0168                                0x085a
#define RG_MDC_016C                                0x085b
#define RG_MDC_0170                                0x085c
#define RG_MDC_0174                                0x085d
#define RG_MDC_0178                                0x085e
#define RG_MDC_017C                                0x085f
#define RG_MDC_0180                                0x0860
#define RG_MDC_0184                                0x0861
#define RG_MDC_0188                                0x0862
#define RG_MDC_018C                                0x0863
...
//
// Closing file:  ../dmc_v28/rtl/dmc_reg.vh
//
