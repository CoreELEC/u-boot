...
elif [ "${BL30_SELECT}" == "s7_t233" ]; then
	declare CONFIG_BOARD_PACKAGE_NAME="t233_s905y5"
elif [ "${BL30_SELECT}" == "s7_bp201" ]; then
	declare CONFIG_BOARD_PACKAGE_NAME="bp201_s805x3"
